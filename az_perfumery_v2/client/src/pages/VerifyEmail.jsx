    ...
    return (
        <div className="min-h-[calc(100vh-80px)] flex items-center justify-center bg-gray-50 py-12 px-4">
            <div className="max-w-md w-full bg-white rounded-3xl shadow-xl p-8 border border-gray-100 text-center">
                ...
                <h2 className="text-2xl font-bold text-gray-800">E-maili Təsdiqləyin</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <input
                        ...
                        placeholder="000000"
                        className="w-full text-center tracking-[1em] text-2xl font-bold py-3 bg-gray-50 border border-gray-200 rounded-xl focus:border-orange-500 outline-none"
                        required
                    />
                    <button className="w-full bg-black text-white py-4 rounded-xl font-bold hover:bg-orange-600 transition-all active:scale-[0.98]">
                        Təsdiqlə
                    </button>
